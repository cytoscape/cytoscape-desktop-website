      ...
      >
        <div className="divide-y divide-gray-100">
          <svg x="0" y="0" width="350" height="310" viewBox="0, 0, 350, 310">
            <path d="M5,12 L345,12 C346.105,12 347,12.895 347,14 L347,22 C347,23.105 346.105,24 345,24 L5,24 C3.895,24 3,23.105 3,22 L3,14 C3,12.895 3.895,12 5,12 z" fill="#b5b5b5"/>
            <path d="M5,28 L249.667,28 C250.771,28 251.667,28.895 251.667,30 L251.667,38 C251.667,39.105 250.771,40 249.667,40 L5,40 C3.895,40 3,39.105 3,38 L3,30 C3,28.895 3.895,28 5,28 z" fill="#b5b5b5"/>
            <path d="M4,60 L70.667,60 C71.219,60 71.667,60.448 71.667,61 L71.667,67 C71.667,67.552 71.219,68 70.667,68 L4,68 C3.448,68 3,67.552 3,67 L3,61 C3,60.448 3.448,60 4,60 z" fill="#b5b5b5"/>
            <path d="M4,152 L107.333,152 C107.886,152 108.333,152.448 108.333,153 L108.333,159 C108.333,159.552 107.886,160 107.333,160 L4,160 C3.448,160 3,159.552 3,159 L3,153 C3,152.448 3.448,152 4,152 z" fill="#b5b5b5"/>
            <path d="M4,72 L169,72 C169.552,72 170,72.448 170,73 L170,143 C170,143.552 169.552,144 169,144 L4,144 C3.448,144 3,143.552 3,143 L3,73 C3,72.448 3.448,72 4,72 z" fill="#b5b5b5"/>
            <path d="M4,164 L169,164 C169.552,164 170,164.448 170,165 L170,309 C170,309.552 169.552,310 169,310 L4,310 C3.448,310 3,309.552 3,309 L3,165 C3,164.448 3.448,164 4,164 z" fill="#b5b5b5"/>
            <g>
              <g>
              ...
              <path d="M304.089,135.953 C304.089,141.061 300.155,145.202 295.302,145.202 C290.449,145.202 286.515,141.061 286.515,135.953 C286.515,130.844 290.449,126.703 295.302,126.703 C300.155,126.703 304.089,130.844 304.089,135.953 z" fill="#666666"/>
              <path d="M305.26,173.056 C305.26,174.516 304.136,175.699 302.749,175.699 C301.363,175.699 300.238,174.516 300.238,173.056 C300.238,171.596 301.363,170.413 302.749,170.413 C304.136,170.413 305.26,171.596 305.26,173.056 z" fill="#999999"/>
              <path d="M234.53,96.326 C234.53,98.376 232.952,100.036 231.005,100.036 C229.058,100.036 227.48,98.376 227.48,96.326 C227.48,94.277 229.058,92.616 231.005,92.616 C232.952,92.616 234.53,94.277 234.53,96.326 z" fill="#999999"/>
              <path d="M238.737,235.547 C238.737,239.343 235.813,242.42 232.207,242.42 C228.601,242.42 225.677,239.343 225.677,235.547 C225.677,231.751 228.601,228.674 232.207,228.674 C235.813,228.674 238.737,231.751 238.737,235.547 z" fill="#999999"/>
              <path d="M234.125,136.514 C234.125,141.622 230.191,145.763 225.338,145.763 C220.485,145.763 216.551,141.622 216.551,136.514 C216.551,131.405 220.485,127.264 225.338,127.264 C230.191,127.264 234.125,131.405 234.125,136.514 z" fill="#666666"/>
              <path d="M291.961,201.723 C291.961,206.832 288.027,210.973 283.174,210.973 C278.32,210.973 274.386,206.832 274.386,201.723 C274.386,196.614 278.32,192.473 283.174,192.473 C288.027,192.473 291.961,196.614 291.961,201.723 z" fill="#666666"/>
              <path d="M193.188,177.77 C193.188,180.161 191.346,182.099 189.075,182.099 C186.803,182.099 184.962,180.161 184.962,177.77 C184.962,175.379 186.803,173.441 189.075,173.441 C191.346,173.441 193.188,175.379 193.188,177.77 z" fill="#999999"/>
              <path d="M221.377,175.068 C221.377,176.809 220.035,178.22 218.381,178.22 C216.728,178.22 215.387,176.809 215.387,175.068 C215.387,173.327 216.728,171.915 218.381,171.915 C220.035,171.915 221.377,173.327 221.377,175.068 z" fill="#999999"/>
              <path d="M243.48,203.189 C243.48,205.644 241.59,207.633 239.258,207.633 C236.927,207.633 235.037,205.644 235.037,203.189 C235.037,200.735 236.927,198.746 239.258,198.746 C241.59,198.746 243.48,200.735 243.48,203.189 z" fill="#999999"/>
              <path d="M262.885,117.525 C262.885,119.28 261.534,120.703 259.866,120.703 C258.199,120.703 256.848,119.28 256.848,117.525 C256.848,115.77 258.199,114.348 259.866,114.348 C261.534,114.348 262.885,115.77 262.885,117.525 z" fill="#999999"/>
            </g>
            <path d="M181.333,250 L197,250 C197.552,250 198,250.448 198,251 L198,253 C198,253.552 197.552,254 197,254 L181.333,254 C180.781,254 180.333,253.552 180.333,253 L180.333,251 C180.333,250.448 180.781,250 181.333,250 z" fill="#b5b5b5"/>
            <path d="M200.333,250 L261,250 C261.552,250 262,250.448 262,251 L262,253 C262,253.552 261.552,254 261,254 L200.333,254 C199.781,254 199.333,253.552 199.333,253 L199.333,251 C199.333,250.448 199.781,250 200.333,250 z" fill="#b5b5b5"/>
            <path d="M181.333,262 L346,262 C346.552,262 347,262.448 347,263 L347,309 C347,309.552 346.552,310 346,310 L181.333,310 C180.781,310 180.333,309.552 180.333,309 L180.333,263 C180.333,262.448 180.781,262 181.333,262 z" fill="#b5b5b5"/>
          </svg>
        </div>
      </MotionAppScreenBody>
    </AppScreen>
        ...
        {features.map((feature, featureIndex) => (
          ...
          >
            <div className="relative transform overflow-hidden rounded-2xl bg-gray-800 px-5 py-6">
              ...
              <AppFrame className="relative mx-auto w-full max-w-[366px] xs:aspect-[246/408]">
                <feature.screen />
              </AppFrame>
