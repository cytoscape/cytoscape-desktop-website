      ...
      >
        <div className="divide-y divide-gray-100">
          <svg x="0" y="0" width="350" height="310" viewBox="0, 0, 350, 310">
            ...
            <path d="M4,152 L107.333,152 C107.886,152 108.333,152.448 108.333,153 L108.333,159 C108.333,159.552 107.886,160 107.333,160 L4,160 C3.448,160 3,159.552 3,159 L3,153 C3,152.448 3.448,152 4,152 z" fill="#dddddd"/>
            <path d="M4,72 L169,72 C169.552,72 170,72.448 170,73 L170,143 C170,143.552 169.552,144 169,144 L4,144 C3.448,144 3,143.552 3,143 L3,73 C3,72.448 3.448,72 4,72 z" fill="#dddddd"/>
            <path d="M4,164 L169,164 C169.552,164 170,164.448 170,165 L170,309 C170,309.552 169.552,310 169,310 L4,310 C3.448,310 3,309.552 3,309 L3,165 C3,164.448 3.448,164 4,164 z" fill="#dddddd"/>
            <g>
              <g>
                <path d="M180.833,60.5 L347.5,60.5 L347.5,247.833 L180.833,247.833 L180.833,60.5 z" fill="#ffffff"/>
                <path d="M180.833,60.5 L347.5,60.5 L347.5,247.833 L180.833,247.833 L180.833,60.5 z" fillOpacity="0" stroke="#dddddd" strokeWidth="1"/>
              </g>
              <g>
            ...
            <path d="M181.333,250 L197,250 C197.552,250 198,250.448 198,251 L198,253 C198,253.552 197.552,254 197,254 L181.333,254 C180.781,254 180.333,253.552 180.333,253 L180.333,251 C180.333,250.448 180.781,250 181.333,250 z" fill="#dddddd"/>
            <path d="M200.333,250 L261,250 C261.552,250 262,250.448 262,251 L262,253 C262,253.552 261.552,254 261,254 L200.333,254 C199.781,254 199.333,253.552 199.333,253 L199.333,251 C199.333,250.448 199.781,250 200.333,250 z" fill="#dddddd"/>
            <path d="M181.333,262 L346,262 C346.552,262 347,262.448 347,263 L347,309 C347,309.552 346.552,310 346,310 L181.333,310 C180.781,310 180.333,309.552 180.333,309 L180.333,263 C180.333,262.448 180.781,262 181.333,262 z" fill="#dddddd"/>
          </svg>
        </div>
      </MotionAppScreenBody>
    </AppScreen>
